describe("Objects", () => {
  ...
  describe("get set", () => {
    ...
    it("you can use . to set the value of a property", () => {
      object.hello = "you";
      expect({"all": 42, "hello": "you"}).toEqual(object);
    });

    it("you can use [string] to set the value of a property", () => {
      object["hello"] = "here";
      expect({"all": 42, "hello": "here"}).toEqual(object);
    });
  ...
  xdescribe("complete later", () => {
    ...
    describe("get set", () => {
      ...
      it("non string keys are converted into string, consider using Map", () => {
        ...
        expect("hint").toEqual(object[redCar]);
      });
